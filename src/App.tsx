...
function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#f8f8f8] flex font-sans">
      {/* Mobile Top Bar */}
      <div className="md:hidden bg-white border-b border-gray-200 fixed top-0 w-full z-20 px-4 py-4 flex items-center justify-between">
        <div className="text-lg font-medium tracking-[0.2em] uppercase">
          CHELLAH <span className="text-xs text-gray-400 tracking-[0.3em]">ADMIN</span>
        </div>
      ...
      {/* Sidebar */}
      <aside className={`w-64 bg-white border-r border-gray-200 flex flex-col fixed h-full z-40 transform transition-transform duration-300 ease-in-out ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0`}>
        <div className="p-6 md:p-8 border-b border-gray-100 flex items-center justify-between">
          ...
          <button className="md:hidden p-1 -mr-1" onClick={() => setIsMobileMenuOpen(false)}>
            <CloseIcon />
          </button>
        </div>
      ...
      {/* Main Content */}
      <main className="flex-1 md:ml-64 p-4 md:p-12 mt-16 md:mt-0 w-full overflow-hidden">
        <div className="max-w-6xl mx-auto">
          {activeTab === 'portfolio' && (
            <>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8 md:mb-12">
                <div>
                  <h1 className="text-2xl md:text-3xl font-light tracking-wide text-gray-900 mb-2">Portfolio Management</h1>
                  <p className="text-gray-500 text-sm">Upload and organize your photography collections.</p>
                </div>
                <button className="flex items-center justify-center gap-2 bg-black text-white px-6 py-3 rounded-lg hover:bg-gray-800 transition-colors text-sm font-medium w-full sm:w-auto">
                  <UploadIcon />
                  Upload Photos
                </button>
              </div>
              ...
              {/* Filters */}
              <div className="bg-white p-2 rounded-xl border border-gray-200 mb-8 flex overflow-x-auto whitespace-nowrap hide-scrollbar">
          ...
          {activeTab === 'categories' && (
            <>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8 md:mb-12">
                <div>
                  <h1 className="text-2xl md:text-3xl font-light tracking-wide text-gray-900 mb-2">Category Management</h1>
                ...
                <table className="w-full text-left border-collapse min-w-[600px]">
                  <thead>
                    <tr className="bg-gray-50 border-b border-gray-200 text-sm text-gray-500 uppercase tracking-wider">
                      <th className="px-4 md:px-6 py-4 font-medium">Category Name</th>
                      <th className="px-4 md:px-6 py-4 font-medium">URL Path</th>
                      <th className="px-4 md:px-6 py-4 font-medium">Images</th>
                      ...
                      <tr key={cat.path} className="hover:bg-gray-50 transition-colors group">
                        <td className="px-4 md:px-6 py-4">
                          <div className="flex items-center gap-3">
                            ...
                            <span className="font-medium text-gray-900 whitespace-nowrap">{cat.name}</span>
                          </div>
                        </td>
                        <td className="px-4 md:px-6 py-4 text-sm text-gray-500">{cat.path}</td>
                        <td className="px-4 md:px-6 py-4 text-sm text-gray-500">12 items</td>
          ...
          {activeTab === 'layout' && (
            <div>
              <h1 className="text-2xl md:text-3xl font-light tracking-wide text-gray-900 mb-2">Page Layout</h1>
              <p className="text-gray-500 text-sm mb-8 md:mb-12">Configure the appearance of your public pages.</p>
          ...
          {activeTab === 'settings' && (
            <div>
              <h1 className="text-2xl md:text-3xl font-light tracking-wide text-gray-900 mb-2">Settings</h1>
              <p className="text-gray-500 text-sm mb-8 md:mb-12">Manage your account and website configuration.</p>
              <div className="bg-white p-8 rounded-xl border border-gray-200 text-center text-gray-500">
